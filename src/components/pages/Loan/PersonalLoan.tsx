...
import Bg1 from "../../../assets/personal-loan.jpg";
import rating from "../../../assets/rating.svg";
import thumbsup from "../../../assets/thumbs-up.svg";
import customerServiceIcon from "../../../assets/customer-service.svg";
import WarrantyIcon from "../../../assets/warranty.svg";
import PersonalLoanForm from "../form/PersonalLoanForm";

const PersonalLoan = ({ info }: { info: LoanCategoryProps }) => {
    return (
        <Grid
          container
          className="bg-tab"
        ...
        >
          <Grid item xs={12} md={6} className="p-40">
            ...
            <Typography className="pt-10">
              Personal Loans are a type of loan designed specifically for
              Personals. These loans are typically offered by banks and other
              financial institutions, and they provide a way for Personals to
              meet their educational, Personal and personal expenses.
            </Typography>
