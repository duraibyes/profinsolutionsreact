...
const Footer = () => {
  return (
    <Grid container className="main-section" spacing={2} sx={{borderTop:'3px solid #ddd'}}>
      ...
      <Grid item xs={12}>
        <Typography className="text-center footer-text py-10" sx={{marginTop:'15px', marginBottom: '20px'}} >
